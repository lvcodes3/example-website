...
export const Contact = () => {
  ...
  return (
    <div
      id='contact-section'
      className='max-w-90% mx-auto mt-10 mb-14 flex md:flex-row flex-col justify-between lg:px-10% px-5%'
    >
      <div className='basis-48% text-slate-600'>
        <div className='flex items-center mb-5'>
          <h3 className='text-xl font-bold text-blue-700'>Send Us A Message</h3>
          <Image
            src='/msg-icon.png'
            alt='Message Icon'
            width={35}
        ...
        <p className='max-w-md'>
          ...
          sapiente numquam odit reprehenderit, atque consequatur repudiandae
          totam dolore doloremque modi suscipit architecto! Dolorem, aspernatur
          repudiandae aperiam earum facilis atque asperiores?
        </p>
        <ul>
